...
public class BookDirectoryTestSuite{
    ...
    @Test
    public void testListBooksInHandsOfDidNotBorrowed(){
    ...
    public void testListBooksInHandsOfOneBookBorrowed(){
        //Given
        List<Book> listOfZeroBooks = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(listOfZeroBooks);
        //When
        List<Book> resultListBooksInHandsOf = bookLibrary.listBooksInHandsOf(any(LibraryUser.class));
        //Then
    ...
    @Test
    public void testListBooksInHandsOfFiveBookBorrowed(){
        //Given
        List<Book> listOfZeroBooks = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(any(LibraryUser.class))).thenReturn(listOfZeroBooks);
        //When
        List<Book> resultListBooksInHandsOf = bookLibrary.listBooksInHandsOf(any(LibraryUser.class));
        //Then
